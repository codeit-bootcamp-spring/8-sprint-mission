...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ErrorResponse> handleAuthorizationDeniedException(AuthorizationDeniedException e) {
        log.warn("[GlobalExceptionHandler] 권한 부족 (AuthorizationDeniedException): {}", e.getMessage());

        DiscodeitException discodeitException = new DiscodeitException(ErrorCode.ACCESS_DENIED);
