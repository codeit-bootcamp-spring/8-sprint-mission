...
COMMENT ON COLUMN read_statuses.notification_enabled IS '알림 여부';
...
COMMENT ON COLUMN notifications.receiver_id IS '수신자 코드';
COMMENT ON COLUMN notifications.title IS '알림 제목';
COMMENT ON COLUMN notifications.content IS '알림 내용';
COMMENT ON COLUMN notifications.created_at IS '알림 생성시간';