...
public class UserControllerTest extends ControllerTestSupport {
    ...
    void createUser_success() throws Exception {
        ...
        UserDto userDto = new UserDto(UUID.randomUUID(), "test", "test@codeit.com", null, false, Role.USER);
    ...
    void updateUser_success() throws Exception {
        ...
        UserUpdateRequest request = new UserUpdateRequest("updatedUser", "updated@example.com",
                "newPassword");
        UserDto userDto = new UserDto(userId, "updatedUser", "updated@example.com", null, true, Role.USER);
