...
public class BasicAuthService implements AuthService {
  ...
  public JwtDto refresh(String refreshToken, HttpServletResponse response) {
    ...
    jwtRegistry.rotateJwtInformation(userId, refreshToken, new JwtInformation(
        userDto, newAccessToken, newRefreshToken, jwtTokenProvider.getExpirationTime(newRefreshToken)
    ));
