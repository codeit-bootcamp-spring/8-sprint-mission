...
public class ReadStatusController implements ReadStatusApi {
  ...
  public ResponseEntity<ReadStatusDto> create(
    ...
    log.info("읽음 상태 생성 요청: userId={}, request={}", currentUser.getUser().getId(), request);
    ReadStatusDto createdReadStatus = readStatusService.create(currentUser.getUser().getId(), request);
  ...
  public ResponseEntity<List<ReadStatusDto>> findAllByUserId(
    ...
    log.info("사용자별 읽음 상태 목록 조회 요청: userId={}", currentUser.getUser().getId());
    List<ReadStatusDto> readStatuses = readStatusService.findAllByUserId(
